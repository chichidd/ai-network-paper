...
lines = [
    r'\begin{table*}[t]',
    r'    \centering',
    r'    \caption{We compare macro F1 against two budget matched baselines at the 50\% communication budget. The full detector pool provides the unconstrained reference. Values report means and 95\% confidence intervals over five repeated splits.}',
